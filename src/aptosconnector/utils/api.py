...
class AptosClient(BaseAPIClient):
    ...
    def submit_dataset_analysis(
        ...
        data: dict = {
            ...
            "jobDescription": f"Automatically generated by AptosConnector on {now_utc_str}",
            "board": "Virtual",
            "parameters": {
                "dataset": [
                    {
            ...
            "groups": [aptos_group_id],
            "notesStructured": "",
            "outputGroupId": aptos_group_id,
        }
